                        ...
                        <div class="carousel-caption">
                            <div class="text-light text-center py-5 px-4">
                                <div>
                                    ...
                                    <p class="mx-5 mb-5">
                                    <h4><br><b>"When you open a book,you open a new world"</b></h4>
                                    <br><br><br>We are here to ensure that even in these difficult times you never have to stop reading ,learning,growing and prospering! <br>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-caption">
                            <div class="text-light text-center py-5 px-4">
                                <div>
                                    ...
                                    <p class="mx-5 mb-5">
                                    <h4><br><b>Upto 1000 different languages</b></h4>
                                    <br><br><br>Right to your doorstep! <br>
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="page-footer font-small bg-dark pt-4">
        ...
        <div class="container">
            ...
            <ul class="list-unstyled list-inline text-center">
                ...
                <li class="list-inline-item">
                    <p>
                        <i class="fas fa-envelope mr-3"></i>solace@gmail.com  |
                    </p>
                </li>
                <li class="list-inline-item">
                    <p>
                        <i class="fas fa-phone mr-3"></i>+ 91 90 234 567 88  |
                    </p>
                </li>
                <li class="list-inline-item">
                    <p>
                        <i class="fas fa-print mr-3"></i>+ 91 90 234 567 89
                    </p>
                </li>
            </ul>
            <!-- Social buttons -->
